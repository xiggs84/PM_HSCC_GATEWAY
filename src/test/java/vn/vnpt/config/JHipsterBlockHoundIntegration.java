...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("vn.vnpt.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("vn.vnpt.security.DomainUserDetailsService", "createSpringSecurityUser");
