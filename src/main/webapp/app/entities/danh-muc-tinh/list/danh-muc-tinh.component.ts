...
import { EntityArrayResponseType, DanhMucTinhService } from '../service/danh-muc-tinh.service';
...
export class DanhMucTinhComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDanhMucTinh): number => this.danhMucTinhService.getDanhMucTinhIdentifier(item);
