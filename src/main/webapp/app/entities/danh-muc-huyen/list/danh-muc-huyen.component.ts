...
import { EntityArrayResponseType, DanhMucHuyenService } from '../service/danh-muc-huyen.service';
...
export class DanhMucHuyenComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDanhMucHuyen): number => this.danhMucHuyenService.getDanhMucHuyenIdentifier(item);
