...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../tai-san-dgc.test-samples';

import { TaiSanDgcService, RestTaiSanDgc } from './tai-san-dgc.service';
