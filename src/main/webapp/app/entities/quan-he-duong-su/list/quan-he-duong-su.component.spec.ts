...
import { QuanHeDuongSuComponent } from './quan-he-duong-su.component';
import SpyInstance = jest.SpyInstance;

describe('QuanHeDuongSu Management Component', () => {
  let comp: QuanHeDuongSuComponent;
  let fixture: ComponentFixture<QuanHeDuongSuComponent>;
  let service: QuanHeDuongSuService;
  let routerNavigateSpy: SpyInstance<Promise<boolean>>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [QuanHeDuongSuComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(QuanHeDuongSuComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(QuanHeDuongSuComponent);
