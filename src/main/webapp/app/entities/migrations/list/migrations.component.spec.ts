...
import { sampleWithRequiredData } from '../migrations.test-samples';
...
describe('Migrations Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to migrationsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMigrationsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMigrationsIdentifier).toHaveBeenCalledWith(entity);
