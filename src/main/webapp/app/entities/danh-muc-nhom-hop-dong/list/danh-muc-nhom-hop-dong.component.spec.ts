...
import { DanhMucNhomHopDongComponent } from './danh-muc-nhom-hop-dong.component';
import SpyInstance = jest.SpyInstance;

describe('DanhMucNhomHopDong Management Component', () => {
  let comp: DanhMucNhomHopDongComponent;
  let fixture: ComponentFixture<DanhMucNhomHopDongComponent>;
  let service: DanhMucNhomHopDongService;
  let routerNavigateSpy: SpyInstance<Promise<boolean>>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [DanhMucNhomHopDongComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(DanhMucNhomHopDongComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(DanhMucNhomHopDongComponent);
